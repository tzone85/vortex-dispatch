...
│  │                                          │ │
│  │ Databases inside:                        │ │
│  │   - sample-prod-snapshot (template)      │ │
│  │   - vxd-sample-api-a8cbef1f-3a (story)   │ │
│  │   - vxd-sample-api-3b8901cd-1f (story)   │ │
│  └─────────────────────────────────────────┘ │
└──────────────────────────────────────────────┘
```
...
gunzip -c client-prod.dump.gz | vxd db template create sample-prod-snapshot --from-stdin

# Refresh weekly
vxd db template refresh sample-prod-snapshot --source ~/snapshots/latest.dump.gz
```
